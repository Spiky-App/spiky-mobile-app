...
const LogoAndIconSvg = (props: SvgProps) => {
  const originalWidth = 892;
  const originalHeight = 379;
  ...
  return (
    ...
    >
      <Svg width="100%" height="100%" viewBox={`0 0 ${originalWidth} ${originalHeight}`} {...props}>
        <G data-name="Grupo 309" transform="translate(-237 -195)">
          <G data-name="Grupo 308">
            <G data-name="Grupo 307">
              <G data-name="Grupo 294">
                <G data-name="Grupo 290" transform="translate(-98.214 -34)" fill="#956060">
                  <Path data-name="Rect\xE1ngulo 367" d="M574 501h328v30.5H574z" />
                  <Rect
                    data-name="Rect\xE1ngulo 368"
                    width={38}
                    height={32}
                    rx={1}
                    transform="translate(680 294.724)"
                  />
                </G>
                <G data-name="Grupo 293" transform="rotate(-20.97 897.253 630.237)">
                  <Path
              ...
              <G transform="translate(221.089 184.743)">
                <Path
