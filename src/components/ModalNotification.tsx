    ...
    <Modal animationType="fade" visible={modalNotif} transparent={true}>
      <TouchableWithoutFeedback onPress={() => setModalNotif(false)}>
        <View style={styles.backmodal}>
          <TouchableWithoutFeedback>
            <View style={{ ...stylescom.container, paddingHorizontal: 25, paddingVertical: 15 }}>
              ...
              <View style={{ marginHorizontal: 5, marginTop: 20, marginBottom: 35, flex: 1 }}>
                {loading ? (
                  <Text>Cargando...</Text>
                  ...
                  <View style={{ ...styles.center, flex: 1 }}>
                    <Text style={{ ...styles.text, ...styles.textGrayPad, textAlign: 'center' }}>
