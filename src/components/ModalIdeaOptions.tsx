          ...
          <TouchableWithoutFeedback>
            ...
            >
              {!myIdea ? (
                <>
                  <TouchableOpacity
                    style={{ ...styles.flex, ...styles.center, paddingHorizontal: 14 }}
                    onPress={() => {}}
                  >
                    <FontAwesomeIcon icon={faThumbtack} color="#01192E" size={13} />
                    <Text
                      style={{ ...styles.text, fontSize: 13, marginLeft: 8, paddingVertical: 6 }}
                    >
                      Tracking
                    </Text>
                  </TouchableOpacity>
                ...
                >
                  ...
                  <Text style={{ ...styles.text, fontSize: 13, marginLeft: 8, paddingVertical: 6 }}>
                    Eliminar
                  </Text>
                </TouchableOpacity>
              )}
